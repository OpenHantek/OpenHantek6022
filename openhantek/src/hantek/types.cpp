...
uint32_t BulkSetTriggerAndSamplerate::getTriggerPosition() {
  return (uint32_t)this->array[6] | ((uint32_t)this->array[7] << 8) |
         ((uint32_t)this->array[10] << 16);
}
...
/// \param recordLength The ::RecordLengthId value.
BulkSetBuffer5200::BulkSetBuffer5200(uint16_t triggerPositionPre,
...
BulkSetTrigger5200::BulkSetTrigger5200(uint8_t triggerSource,
...
uint32_t BulkSetBuffer2250::getTriggerPositionPost() {
  return (uint32_t)this->array[2] | ((uint32_t)this->array[3] << 8) |
         ((uint32_t)this->array[4] << 16);
}
...
uint32_t BulkSetBuffer2250::getTriggerPositionPre() {
  return (uint32_t)this->array[6] | ((uint16_t)this->array[7] << 8) |
         ((uint16_t)this->array[8] << 16);
}
