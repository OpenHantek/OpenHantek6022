...
struct ControlSamplerateLimits {
  ...
  QList<unsigned int>
      recordLengths; ///< Available record lengths, UINT_MAX means rolling
};
...
struct ControlSpecification {
  ...
  QList<unsigned int>
      bufferDividers;       ///< Samplerate dividers for record lengths
...
struct ControlSettings {
  ...
  ControlSettingsVoltage
      voltage[HANTEK_CHANNELS];    ///< The amplification settings
