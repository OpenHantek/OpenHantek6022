...
ModelDSO6022BE::ModelDSO6022BE()
    : DSOModel( ID, 0x04b5, 0x6022, 0x04b4, 0x6022, 0x0206, "dso6022be", "DSO-6022BE",
...
ModelDSO6022BL::ModelDSO6022BL()
    : DSOModel( ID, 0x04b5, 0x602a, 0x04b4, 0x602a, 0x0206, "dso6022bl", "DSO-6022BL",
                Dso::ControlSpecification( 2 ) ) {
    initSpecifications( specification );
}
...
ModelEzUSB::ModelEzUSB()
    : DSOModel( ID, 0x04b5, 0x6022, 0x04b4, 0x8613, 0x0206, "dso6022be", "LCsoft-EzUSB",
                Dso::ControlSpecification( 2 ) ) {
    initSpecifications( specification );
}
...
ModelSaleae::ModelSaleae()
    : DSOModel( ID, 0x04b5, 0x6022, 0x0925, 0x3881, 0x0206, "dso6022be", "LCsoft-Saleae",
                Dso::ControlSpecification( 2 ) ) {
    initSpecifications( specification );
}
