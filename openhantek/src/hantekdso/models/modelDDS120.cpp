...
static void initSpecifications( Dso::ControlSpecification &specification ) {
    ...
    // This model uses the sigrok firmware that has a slightly different coding for the sample rate than my
    // Hantek6022API version. 10=100k, 20=200k, 50=500k, 11=10M (Hantek: 110=100k, 120=200k, 150=500k, 10=10M)
