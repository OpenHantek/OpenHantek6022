...
std::unique_ptr<DataAnalyzerResult> DataAnalyzer::convertData(const DSOsamples* data, const DsoSettingsScope *scope) {
    ...
    std::unique_ptr<DataAnalyzerResult> result = std::unique_ptr<DataAnalyzerResult>(new DataAnalyzerResult(channelCount));
...
std::unique_ptr<DataAnalyzerResult> DataAnalyzer::getNextResult()
{
