...
QString valueToString( double value, Unit unit, int precision ) {
    ...
    case UNIT_VOLTS:
        ...
        if ( bool( fabs( value ) ) ) {
            ...
            return QApplication::tr( "%L1 V" ).arg( 0 );
    ...
    case UNIT_WATTS:
        ...
        if ( bool( fabs( value ) ) ) {
            ...
            return QApplication::tr( "%L1 W" ).arg( 0 );
    ...
    case UNIT_SECONDS:
        ...
        if ( bool( fabs( value ) ) ) {
            ...
            return QApplication::tr( "%L1 s" ).arg( 0 );
    ...
    case UNIT_HERTZ:
        ...
        if ( bool( fabs( value ) ) ) {
            ...
            return QApplication::tr( "%L1 Hz" ).arg( 0 );
