...
It was initially developped by [David Gräff and others](https://github.com/OpenHantek/openhantek/graphs/contributors) on [github.com/OpenHantek/openhantek](https://github.com/OpenHantek/openhantek). After David [stopped maintaining](https://github.com/OpenHantek/openhantek/issues/277) the programm I cloned the repo to provide some updates - but only for Hantek 6022BE/BL on the linux platform.
...
Navigate to the [Releases](https://github.com/Ho-Ro/openhantek/releases) page.
* [Download Windows build](https://ci.appveyor.com/project/Ho-Ro/openhantek/branch/master/artifacts)
...
* On Linux, you need to copy the file `firmware/60-hantek.rules` to `/etc/udev/rules.d/` and replug your device.
